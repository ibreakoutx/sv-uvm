...
endclass
   ...
   function ec_ral_env::new() ;
      ...
      // ec_bind =  ec_bind_in;
      // ral = new(); // needed?? don't think so
      // ral_block_ec_timer_0 = new();  
      // if ( ral_block_ec_timer_0 == null);
      //    `vmm_error(log, "ral_block_ec_timer_0 is null");
      // if ( ral == null);
      //    `vmm_error(log, "ral is null");
      `vmm_debug(log, "set_model");
      ral.set_model(ral_block_ec_timer_0);
      // ec_ral_bfm_0 = new(ec_bind); // ec_top_mod.ec_intf_0);
   ...
   //    super.reset_dut();
   //    `vmm_debug(log, "ec_ral_env::reset_dut()  ");
      // hw_reset(); // called automatcialyl
   // endtask // endtask
