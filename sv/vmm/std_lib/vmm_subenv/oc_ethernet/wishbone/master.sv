...
function wb_master::new(string               instance,
                        int unsigned         stream_id,
                        wb_cfg               cfg,
                        virtual wb_if.master sigs,
                        wb_cycle_channel     exec_chan);
   super.new("Wishbone Master", instance, stream_id);
   ...
   if (exec_chan == null) exec_chan = new("Wishbone Master Execution Channel", instance);
...
function void wb_master::reset_xactor(reset_e rst_typ);
