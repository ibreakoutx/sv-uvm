...
function wb_slave::new(string                instance,
                       ...
                       wb_cycle_resp_channel resp_chan,
                       wb_cycle              req_factory);
   super.new("Wishbone Slave", instance, stream_id);
...
function void wb_slave::reconfigure(wb_slave_cfg cfg);
   this.cfg = cfg;
endfunction: reconfigure

   
function void wb_slave::reset_xactor(reset_e rst_typ);
...
function wb_ram::new(string                instance,
                     int unsigned          stream_id,
                     wb_cycle_channel      req_chan,
                     wb_cycle_resp_channel resp_chan,
                     wb_cycle_resp         resp_factory);
   super.new("Wishbone RAM", instance, stream_id);
...
function void wb_ram::reset_xactor(reset_e rst_typ);
   super.reset_xactor(rst_typ);
endfunction: reset_xactor
