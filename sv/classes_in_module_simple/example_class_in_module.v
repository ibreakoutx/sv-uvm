...
// this is an example of how to use the OO Classes in Modules
// here we have declared the class in $root, and instantiate it in the moduel
...
endclass
	...
	// here we have a module, just happens to have no port list but it could!
...
initial begin
		...
		// now in the module we start to do some OO in a module! 
