...
class mii_mac_layer extends vmm_xactor;
   ...
   function new(string                   instance,
      ...
      super.new("MII MAC Layer", instance, stream_id);
      ...
      if (tx_chan == null) begin
         tx_chan = new({this.log.get_name(), " MAC->PHY frames"}, instance);
      end
      this.tx_chan = tx_chan;
      if (rx_chan == null) rx_chan = new({this.log.get_name(), " PHY->MAC frames"}, instance);
...
function void mii_mac_layer::reconfigure(mii_cfg   cfg,
...
// Example 4-52
function void mii_mac_layer::reset_xactor(reset_e typ);
