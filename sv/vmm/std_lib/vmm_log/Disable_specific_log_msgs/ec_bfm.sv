...
class ec_bfm extends vmm_xactor;
   ...
   function new();
	   ...
	   `ifdef DISABLE_CH_MSG
	   // The following disables the channel messages with name "ec_bfm"

	   
	   ch_in.log.disable_types(vmm_log::NOTE_TYP + vmm_log::DEBUG_TYP + vmm_log::TIMING_TYP + vmm_log::XHANDLING_TYP + vmm_log::REPORT_TYP + vmm_log::PROTOCOL_TYP + vmm_log::TRANSACTION_TYP + vmm_log::COMMAND_TYP + vmm_log::CYCLE_TYP + vmm_log::INTERNAL_TYP ,"/ec_bfm/","/./", 1);  // Addition of all types 
